...
P.evaluate(d,(_,opts)=>({recommended:opts[0],ranked:opts}));assert.ok(d.recommendation,'a complete, optimizable universe should reach the canonical evaluator and produce a recommendation');
