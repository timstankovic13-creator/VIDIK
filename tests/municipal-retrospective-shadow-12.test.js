...
const cases=[
 {municipality:'Ottawa',jurisdiction:'CA-ON',source:{provider:'City of Ottawa',url:'https://documents.ottawa.ca/sites/default/files/2024HHReport_EN.pdf',recordId:'ottawa-hh-2024',publishedAt:'2024-12-31'},decision:{decisionId:'ottawa-shadow-2024',decisionDate:'2024-12-31',recommendation:'housing'},evidence:{claims:[{claimId:'o1',sourceRecordId:'ottawa-hh-2024',asOf:'2024-12-31'}]},outcome:{metric:'Housing First housed count',measuredAt:'2025-12-31',observed:398},comparison:{actualDecision:'housing'}},
 {municipality:'Toronto',jurisdiction:'CA-ON',source:{provider:'City of Toronto',url:'https://www.toronto.ca/',recordId:'toronto-shelter-2024',publishedAt:'2024-12-31'},decision:{decisionId:'toronto-shadow-2024',decisionDate:'2024-12-31',recommendation:'supportive-housing'},evidence:{claims:[{claimId:'t1',sourceRecordId:'toronto-shelter-2024',asOf:'2024-12-31'}]},outcome:{metric:'people moved to permanent housing',measuredAt:'2025-12-31',observed:4300},comparison:{actualDecision:'shelter-expansion'}},
