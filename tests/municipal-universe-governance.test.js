...
const verification={problem:'Minimize violent crime',universeId:hot.id,evidenceIds:['review:hotspots'],cost:100000,capacity:10,expectedValue:5,objectiveMetric:'violent-crime-rate',uncertainty:{low:2,high:8},constraints:{legal:[],implementation:[],capacity:[]}};
