...
const DISCOVERY_RECALL_PACKS = Object.freeze([
  ...
  { workspace: 'municipal|community', match: /youth violence|youth firearm violence/i, terms: ['youth violence interruption','credible messenger','youth mentoring','focused deterrence','hospital-based violence intervention','summer youth employment'] },
  { workspace: 'municipal|community', match: /disaster preparedness|emergency preparedness/i, terms: ['community emergency preparedness','emergency preparedness training','evacuation planning','resilience hub','early warning system','emergency supplies program'] },
  { workspace: 'municipal|community', match: /reduce heat exposure|heat exposure|extreme heat/i, terms: ['cooling centre','clean air shelter','home cooling','shade infrastructure','tree canopy','cooling infrastructure'] },
  { workspace: 'municipal|community', match: /wildfire evacuation barriers|bushfire evacuation barriers|evacuation constraints|evacuation access/i, terms: ['wildfire evacuation support','evacuation assistance','emergency transportation','safe passage','community evacuation planning','evacuation route improvement'] },
