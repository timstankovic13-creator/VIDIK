...
function summarize(result) { return result.comparison.map(city => ({ city: city.city, state: city.state, recommendation: city.recommendation, observedValue: city.observedValue, optimization: city.optimization })); }
